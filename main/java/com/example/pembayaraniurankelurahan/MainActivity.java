...
//                    Toast.makeText(getApplicationContext(),""+radiobtnchoose.getText().toString(),Toast.LENGTH_SHORT).show();
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Form Iuran Kelurahan");
...
//        });
    ...
    private void showDialog() {
        ...
        // Dialog digunakan untuk menanyakan apakah data yang diinputkan sudah benar atau belum
...
//                        Toast.makeText(getApplicationContext(),"" + editTextnama.getText().toString(), Toast.LENGTH_SHORT).show();
                        ...
                        // intent digunakan untuk berpindah halaman dari satu halaman ke halaman lainnya
