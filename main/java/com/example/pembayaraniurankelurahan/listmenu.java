...
import com.example.pembayaraniurankelurahan.adapter.wargaAdapter;
import com.example.pembayaraniurankelurahan.db.AppDatabase;
import com.example.pembayaraniurankelurahan.db.wargaEntity;

public class listmenu extends AppCompatActivity {
    private RecyclerView recyclerView;
    private com.example.pembayaraniurankelurahan.adapter.wargaAdapter WargaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WargaAdapter.setDialog(new wargaAdapter.Dialog() {
            ...
            public void onClick(int position) {
                ...
                dialog = new AlertDialog.Builder(com.example.pembayaraniurankelurahan.listmenu.this);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case 0:
                                ...
                                Intent intent = new Intent(com.example.pembayaraniurankelurahan.listmenu.this, MainActivity.class);
...
//        Toast.makeText(this,"Selamat datang" + getiuran.getStringExtra("nama"),Toast.LENGTH_SHORT).show();
        savebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent pindahAct = new Intent(com.example.pembayaraniurankelurahan.listmenu.this, home.class);
